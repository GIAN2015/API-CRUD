            ...
            <tr v-for="user in store.users" :key="user.id" class="bg-white hover:bg-slate-50 transition-colors">
              ...
              <td class="px-6 py-4 text-center whitespace-nowrap flex justify-center gap-3">
                <button 
                  ...
                  class="text-amber-500 hover:text-amber-700 font-medium transition-colors" title="Editar">
                ...
                <button 
                  ...
                  class="text-red-500 hover:text-red-700 font-medium transition-colors" title="Eliminar">
                  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-5 h-5">
